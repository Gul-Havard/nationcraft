...
public class BlockTinOre extends Block implements IHasModel, IMetaName {
	
	public static final PropertyEnum<EnumHandler.EnumType> VARIANT = PropertyEnum.<EnumHandler.EnumType>create("variant", EnumHandler.EnumType.class);
	private String name, dimension;

	public BlockTinOre(String name, String dimension) {
		super(Material.ROCK);
	...
	public void registerModels()
	{
		...
		{
			Main.proxy.registerVarientRenderer(Item.getItemFromBlock(this), i, "tin_ore" + EnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
