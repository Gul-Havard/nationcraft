...
import com.gulhavard.nationcraft.blocks.BlockBlastFurnace;
...
public class TileEntityBlastFurnace extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.blast_furnace";
	}
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = BlastFurnaceRecipes.getInstance().getBlastResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = BlastFurnaceRecipes.getInstance().getBlastResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
	...
	{
		return "nationcraft:blast_furnace";
	}
